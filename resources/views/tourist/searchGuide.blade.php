...
<nav class="navbar navbar-expand-sm bg-light navbar-light fixed-top">
  ...
  <ul class="navbar-nav">
    ...
    <form  method="POST" action="{{ '/selectGuide' }}" onsubmit="return (sendData1('country','state') && validateCity())">
    {{ csrf_field() }}
    <div class="container">
    ...
    <input type="text" id="end_date" name="end_date" class="form-control" >
     ...
     <div class="form-group">
    <label for="end_date">Booking start Time:</label>
    <input type="text" id="start_time" name="start_time" class="form-control" >
   
     </div>

     <div class="form-group">
    <label for="end_date">Booking ending Time:</label>
