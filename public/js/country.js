...
function populateStates(countryElementId, stateElementId) {
   ...
   // window.alert(selectedCountryIndex);
    var stateElement = document.getElementById(stateElementId);

    stateElement.length = 0; // Fixed by Julian Woods
    stateElement.options[0] = new Option('Select State', '');
    stateElement.selectedIndex = 0;
   // window.alert(s_a[selectedCountryIndex]);
    var state_arr=[];
...
function populateCountries(countryElementId, stateElementId) {
    ...
    // Assigned all countries. Now assign event listener for the states.
           ...
           // window.alert(countryElement);
           
            //populateStates(countryElementId, stateElementId);
        
    }
    
    function sendData(countryElementId,stateElementId)
    {
    var selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;
    ...
    //var state_arr=[];
    state_arr = s_a[selectedCountryIndex].split("|");
    var country=country_arr[selectedCountryIndex];
    var state=state_arr[selectedStateIndex-1];
    console.log(state);
    window.alert(state),
    $.ajax({
        
        url : '{{route("/tourist/store")}}',
        type: "POST",
...
function sendData1(countryElementId,stateElementId)
    {
    var selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;
    var selectedStateIndex = document.getElementById(stateElementId).selectedIndex;
    console.log(selectedStateIndex);
...
function sendData2(countryElementId,stateElementId)
    {
    var selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;
    var selectedStateIndex = document.getElementById(stateElementId).selectedIndex;
    console.log(selectedStateIndex);
...
function sendData3(countryElementId,stateElementId)
    {
    var selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;
    var selectedStateIndex = document.getElementById(stateElementId).selectedIndex;
    console.log(selectedStateIndex);
...
function sendData4(countryElementId,stateElementId)
    {
    var selectedCountryIndex = document.getElementById(countryElementId).selectedIndex;
    var selectedStateIndex = document.getElementById(stateElementId).selectedIndex;
    console.log(selectedStateIndex);
    ...
    $.ajax({
        ...
        url : '{{route("guide/destination/store")}}',
        type: "POST",
        data: {country: country, state: state},
       headers:{'X-CSRF-TOKEN':$('meta[name="csrf-token"]').attr("{{csrf_token()}}")}
